...
const STRINGS = {
  en: {
    ...
    doorWait: ['i~open for those who stop', 'wait for me', 'don’t knock. just be~here', 'the key is~in~your breath', 'stand still. i~can hear~you', 'three breaths', 'you are in~a~hurry. i~am~not'],
    youLabel: 'You',
  ...
  ru: {
    ...
    doorWait: ['я~открываюсь тем, кто остановился', 'подожди меня', 'не~стучи. просто будь', 'ключ у~тебя в~дыхании', 'замри. я~тебя слышу', 'три вдоха', 'ты торопишься. я~нет'],
    youLabel: 'Ты',
